                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo text-center">
                                <img style="width: 22%" src="{{ asset('backend/images/sulsel.png') }}" alt="logo">
                            </div>
                            <h4 class="text-center">Silahkan Registrasi lebih Dahulu Untuk Buat Akun Anda</h4>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mt-3 flex justify-content-between">
                                    ...
                                    <a class="btn btn-block btn-sm font-weight-medium auth-form-btn"
